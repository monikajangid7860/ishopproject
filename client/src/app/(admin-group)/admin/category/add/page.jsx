  ...
  return(
    <section className="bg-white rounded-xl border border-gray-200 shadow-sm max-w-xl w-full">
      <div className="border-b px-6 py-4">
        ...
        <p className="text-sm text-gray-500">Create a category to organize products</p>
      </div>
      ...
      <form onSubmit={submitHandler} className="p-6 space-y-6">
        <div className="space-y-1">
          ...
          <input
            ...
            ref={categoryRef}
            onChange={createSlug}
            placeholder="e.g. Laptops, Cameras"
        ...
        <div className="space-y-1">
          ...
          />
          <p className="text-xs text-gray-400">Auto-generated from category name</p>
        </div>
